        ...
        <>
            ...
            ">
                ...
                ">
                    ...
                    <div className="
                        text-[5.5rem] uppercase text-center text-regal-white font-[600] font-spectral mb-[4rem] mx-auto max-md:text-[2.5rem] max-md:w-full max-md:text-[2.8rem]
                    ">
                        <span className="block text-[8rem] text-regal-beige max-md:text-[4rem]">ВЕЛИКИЙ</span>
                        ВСЕУКРАЇНСЬКИЙ ЗБІР
                    </div>
                </div>
            </div>
